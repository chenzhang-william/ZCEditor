...
import com.zc.editor.base.interfaces.IDetailCallBackListener;
import com.zc.editor.blocks.interfaces.ICallBackListener;
import com.zc.editor.blocks.mediaExtractor.combineTwoVideo.CombineVideoAndMusic;
import com.zc.editor.blocks.mediaExtractor.primary.FrequencyView;
import com.zc.editor.blocks.mediaExtractor.primary.TransAacHandlerPure;
import com.zc.editor.blocks.mediaExtractor.primary.decoder.DecoderAudioAAC2PCMPlay;
import com.zc.editor.blocks.mediaExtractor.primary.decoder.DecoderAudioAndGetDb;
import com.zc.editor.blocks.mediaExtractor.primary.decoder.DecoderMp3FromMp4;
import com.zc.editor.blocks.mediaExtractor.primary.decoder.DecoderNoVoiceMp4FromMp4;
import com.zc.editor.blocks.mediaExtractor.primary.encoder.EncoderAudioAAC;
import com.zc.editor.blocks.mediaExtractor.primary.official.AMediaExtractorOfficial;
...
//                CombineTwoVideos.combineTwoVideos(path + "/zc.mp4", 0, path + "/lan.mp4", new File(path + "/zc.mp3"), this);
