...
import com.zc.editor.blocks.mediaMuxer.primary.MuxerVoiceAndVideoToMp4;
import com.zc.editor.blocks.mediaMuxer.primary.MuxerVoiceDbToMp4;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.muxer_aac_video_to_mp4:
                new MuxerVoiceAndVideoToMp4(path + "/own.m4a", path + "/zc.mp4", path + "/out_aserbao.mp4", new ICallBackListener() {
                    @Override
                    public void success() {
